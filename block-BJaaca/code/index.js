...
character.greet = function () {
  alert(
    `I am ${character.characterName} ${character['sur name']} and my title is ${character.title}`
  );
};
...
character.greet = function () {
  alert(
    `She is ${character.characterName} ${character['sur name']} and her title is ${character.title}`
  );
};
